...
def test_marketable_size_haelt_clob_praezision_ein():
    ...
    # Market-BUY: Size*Preis (Maker-USDC) darf max. 2 Nachkommastellen haben
    # (Server-Regel, Live-Beleg 07.07.). Tick-unabhängig.
    ...
    # Market-SELL: Size*Preis (Taker-USDC) darf max. 4 Nachkommastellen haben.
...
def test_fok_gruppe_wird_auf_gemeinsame_konforme_size_quantisiert():
    ...
    # 10.5*0.43=4.5150 (>2 Dez Maker-USDC) wäre abgelehnt worden -> beide auf 10.0.
...
def test_fok_gruppe_ohne_konforme_size_wird_verworfen():
    ...
    # (kleinste konforme Size ist 1.0 bei p=0.43, Maker-USDC 2 Dez).
